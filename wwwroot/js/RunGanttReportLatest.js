...
datePicker.trigger("change");
		    ...
		    $.ajax({        	       // https://projectmadeeasy.sharepoint.com/sites/pwa/_api/ProjectData/Resources?$Select=ResourceId,ResourceName,PrimaryJobRole
                              url: 'https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_ProjectList/9FA7C3AC-3564-4836-9A50-8951792AF1B4/1 2020/2 2020',                              
							  type: 'GET',
                              async: false,
                              processData: false,
                              cache: false,              
	...
	if(1==0){
			    $.ajax({        	
                              ...
                              url: 'https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_ParameterList/9FA7C3AC-3564-4836-9A50-8951792AF1B4/1 2020/2 2020',                              
							  type: 'GET',
                              async: false,
                              processData: false,
                              cache: false,              
...
if($('#drp_resources').val()!=null)
{
	var singleObj = {};	
			...
			$.ajax({ 
                              ...
                              url: 'https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_ParameterList/WithFilters',
                              type: "PUT",
...
/* 			var YearS= $("#start").val().split(' ')[1];
			...
			var RoleUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_Role/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
			var ResourceUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_Project/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
			var ProjectOnlyUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_ProjectOnly/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
...
/* 			var YearS= $("#start").val().split(' ')[1];
			...
			var RoleUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_Role_Filters/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
			var ResourceUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_Project/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
			var ProjectOnlyUrl='https://pmedemormapp.azurewebsites.net/Api/GanttUpdated_ProjectOnly/9FA7C3AC-3564-4836-9A50-8951792AF1B4/'+startDate+'/'+EndDate;
			var callURL=ResourceUrl;
			callURL=RoleUrl;
...
{ 
	...
	var allData ="'"+ JSON.stringify(data_push)+"'";
		$.LoadingOverlay("show");
	    $.ajax({
                url: 'https://pmedemormapp.azurewebsites.net/Api/GanttUpdated/Commit',
                type: 'POST',
                async: true,
                processData: false,
                cache: false,
